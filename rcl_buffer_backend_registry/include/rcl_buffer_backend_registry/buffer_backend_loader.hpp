...
#ifndef RCL_BUFFER_BACKEND_REGISTRY__BUFFER_BACKEND_LOADER_HPP_
#define RCL_BUFFER_BACKEND_REGISTRY__BUFFER_BACKEND_LOADER_HPP_
...
#endif  // RCL_BUFFER_BACKEND_REGISTRY__BUFFER_BACKEND_LOADER_HPP_
