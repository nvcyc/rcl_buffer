...
def generate_test_description():
    """Generate launch description for 2 pub / 2 sub per topic, CPU-to-CPU test."""
...
class TestCpuToCpu2Pub2Sub(unittest.TestCase):
    """Test case for 2 pub / 2 sub per topic, CPU-to-CPU."""
    ...
    def setUp(self):
        self.node = rclpy.create_node('test_cpu_to_cpu_2pub_2sub')
...
class TestCpuToCpu2Pub2SubShutdown(unittest.TestCase):
    """Test shutdown behavior for CPU to CPU with 2 publishers and 2 subscribers."""
