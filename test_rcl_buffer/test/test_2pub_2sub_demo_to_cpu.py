...
# Demo backend to CPU backend (serialization fallback)
...
def generate_test_description():
    """Generate launch description for 2 pub / 2 sub per topic, Demo-to-CPU test."""

    # Topic 1: Demo publisher with 2 CPU subscribers
    publisher_1 = Node(
    ...
    # Topic 2: Demo publisher with 2 CPU subscribers
    publisher_2 = Node(
        package='test_rcl_buffer',
        executable='demo_backend_image_publisher_node',
...
class TestDemoToCpu2Pub2Sub(unittest.TestCase):
    """Test case for 2 pub / 2 sub per topic, Demo-to-CPU (serialization fallback)."""
    ...
    def setUp(self):
        self.node = rclpy.create_node('test_demo_to_cpu_2pub_2sub')
    ...
    def test_demo_to_cpu_2pub_2sub_messages_delivered(self):
        """Test 2 Demo publishers to 2 CPU subscribers each (serialization)."""
        ...
        self.assertTrue(self._all_validations_passed(),
            f"Validation failed (serialization fallback): "
            f"topic1={self.topic1_validations}, topic2={self.topic2_validations}")


@launch_testing.post_shutdown_test()
class TestDemoToCpu2Pub2SubShutdown(unittest.TestCase):
