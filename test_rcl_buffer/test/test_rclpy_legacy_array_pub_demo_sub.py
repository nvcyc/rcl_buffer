...
#
# Launch test: rclpy legacy array.array publisher to rclpy demo-aware subscriber.
#
# The publisher is a "legacy" node that uses ONLY array.array and has NO
# imports from rcl_buffer or demo_buffer.  The subscriber is the standard
...
class TestRclpyLegacyArrayPubDemoSub(unittest.TestCase):
    ...
    def setUp(self):
        self.node = rclpy.create_node('test_legacy_pub_demo_sub')
...
class TestRclpyLegacyArrayPubDemoSubShutdown(unittest.TestCase):
