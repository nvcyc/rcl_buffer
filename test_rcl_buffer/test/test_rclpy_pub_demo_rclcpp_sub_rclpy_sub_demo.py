...
#
# Launch test: 1 rclpy publisher (demo) to 1 rclcpp subscriber + 1 rclpy subscriber (demo).
...
class TestRclpyPubDemoMixedSub(unittest.TestCase):
    ...
    def setUp(self):
        self.node = rclpy.create_node('test_rclpy_pub_demo_mixed_sub')
...
class TestRclpyPubDemoMixedSubShutdown(unittest.TestCase):
