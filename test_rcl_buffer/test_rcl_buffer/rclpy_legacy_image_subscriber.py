...
from rcl_buffer.  It represents existing user code written before the
...
because rcl_buffer.Buffer is a drop-in replacement for array.array('B').
...
class RclpyLegacyImageSubscriber(Node):
    """Legacy subscriber using only array.array APIs — no rcl_buffer imports."""
