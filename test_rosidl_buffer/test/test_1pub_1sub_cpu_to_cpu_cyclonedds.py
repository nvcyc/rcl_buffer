...
def generate_test_description():
    """Generate launch description for CPU-to-CPU pub/sub test over CycloneDDS."""
    publisher_node = Node(
...
class TestCpuToCpuCycloneDDS(unittest.TestCase):
    """Test case for CPU-to-CPU image pub/sub over CycloneDDS."""
    ...
    def setUp(self):
        self.node = rclpy.create_node('test_cpu_to_cpu_cyclonedds')
    ...
    def test_cpu_to_cpu_messages_delivered(self):
        """Test CPU backend publisher to CPU backend subscriber over CycloneDDS."""
...
class TestCpuToCpuCycloneDDSShutdown(unittest.TestCase):
    """Test shutdown behavior for CPU to CPU communication over CycloneDDS."""
