...
#
# Launch test: cpu pub to cpu sub with acceptable_buffer_backends="cpu" (FastRTPS)
# Verifies that explicit "cpu" works and restricts to CPU-only.
...
def generate_test_description():
    """CPU pub to sub with acceptable_buffer_backends='cpu'."""
    publisher_node = Node(
...
class TestCpuCpuSubCpuFastRTPS(unittest.TestCase):
    """CPU to CPU with acceptable_buffer_backends='cpu'."""
    ...
    def setUp(self):
        self.node = rclpy.create_node('test_cpu_cpu_sub_cpu_fastrtps')
