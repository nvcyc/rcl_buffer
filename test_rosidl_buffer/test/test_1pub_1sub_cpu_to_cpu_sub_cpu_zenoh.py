...
#
# Launch test: cpu pub to cpu sub with acceptable_buffer_backends="cpu" (Zenoh)
...
class TestCpuCpuSubCpuZenoh(unittest.TestCase):
    ...
    def setUp(self):
        self.node = rclpy.create_node('test_cpu_cpu_sub_cpu_zenoh')
