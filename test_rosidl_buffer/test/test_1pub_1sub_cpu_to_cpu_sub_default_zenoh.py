...
#
# Launch test: cpu pub to cpu sub without setting acceptable_buffer_backends (Zenoh)
...
class TestCpuCpuSubDefaultZenoh(unittest.TestCase):
    ...
    def setUp(self):
        self.node = rclpy.create_node('test_cpu_cpu_sub_default_zenoh')
