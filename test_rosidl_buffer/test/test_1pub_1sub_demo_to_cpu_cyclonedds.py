...
#
# Launch test: 1 publisher (demo backend) to 1 subscriber (cpu), CycloneDDS
...
def generate_test_description():
    """Generate launch description for demo-to-cpu pub/sub over CycloneDDS."""
    publisher_node = Node(
...
class TestDemoToCpuCycloneDDS(unittest.TestCase):
    """Test case for demo-backend pub to cpu-backend sub over CycloneDDS."""
    ...
    def test_demo_to_cpu_messages_delivered(self):
        """Test demo backend publisher to cpu subscriber over CycloneDDS."""
...
class TestDemoToCpuCycloneDDSShutdown(unittest.TestCase):
    """Test shutdown for demo-to-cpu communication over CycloneDDS."""
