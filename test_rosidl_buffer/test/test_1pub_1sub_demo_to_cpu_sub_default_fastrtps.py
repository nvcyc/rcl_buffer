...
#
# Launch test: demo pub to cpu sub without setting acceptable_buffer_backends (FastRTPS)
...
class TestDemoCpuSubDefaultFastRTPS(unittest.TestCase):
    ...
    def setUp(self):
        self.node = rclpy.create_node('test_demo_cpu_sub_default_fastrtps')
