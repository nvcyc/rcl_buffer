...
#
# Launch test: demo pub to cpu sub without setting acceptable_buffer_backends (Zenoh)
...
class TestDemoCpuSubDefaultZenoh(unittest.TestCase):
    ...
    def setUp(self):
        self.node = rclpy.create_node('test_demo_cpu_sub_default_zenoh')
