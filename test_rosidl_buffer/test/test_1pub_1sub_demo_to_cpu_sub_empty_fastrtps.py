...
#
# Launch test: demo pub to cpu sub with acceptable_buffer_backends="" (empty) (FastRTPS)
...
class TestDemoCpuSubEmptyFastRTPS(unittest.TestCase):
    ...
    def setUp(self):
        self.node = rclpy.create_node('test_demo_cpu_sub_empty_fastrtps')
