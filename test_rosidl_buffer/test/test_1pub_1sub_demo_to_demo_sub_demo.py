...
#
# Launch test: demo pub to demo sub with acceptable_buffer_backends="demo"
...
class TestDemoDemoSubDemo(unittest.TestCase):
    ...
    def setUp(self):
        self.node = rclpy.create_node('test_demo_demo_sub_demo')
