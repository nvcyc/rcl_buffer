...
#
# Launch test: 1 pub (demo) → 1 intra-process sub (demo) + 1 inter-process sub (demo) (Zenoh)
...
class TestIntraDemoInterDemoZenoh(unittest.TestCase):
    """1 demo pub → 1 demo intra-process sub + 1 demo inter-process sub (Zenoh)."""
    ...
    def setUp(self):
        self.node = rclpy.create_node('test_intra_demo_inter_demo_zenoh')
        self.intra_count = 0
        self.inter_count = 0
...
class TestIntraDemoInterDemoZenohShutdown(unittest.TestCase):
