...
#
# Launch test: 1 rclcpp publisher (CPU) to 1 rclcpp subscriber +
# 1 rclpy subscriber (CPU). (FastRTPS)
...
class TestRclcppPubCpuMixedSubFastRTPS(unittest.TestCase):
    ...
    def setUp(self):
        self.node = rclpy.create_node('test_rclcpp_pub_cpu_mixed_sub_fastrtps')
...
class TestRclcppPubCpuMixedSubFastRTPSShutdown(unittest.TestCase):
