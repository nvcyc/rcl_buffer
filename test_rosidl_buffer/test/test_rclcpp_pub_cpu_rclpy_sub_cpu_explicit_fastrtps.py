...
class TestRclcppPubCpuRclpySubCpuExplicitFastRTPS(unittest.TestCase):
    ...
    def setUp(self):
        self.node = rclpy.create_node('test_rclcpp_pub_cpu_rclpy_sub_cpu_explicit_fastrtps')
...
class TestRclcppPubCpuRclpySubCpuExplicitFastRTPSShutdown(unittest.TestCase):
