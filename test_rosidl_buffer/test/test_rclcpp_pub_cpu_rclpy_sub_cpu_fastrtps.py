...
#
# Launch test: 1 rclcpp publisher (CPU) to 1 rclpy subscriber (CPU). (FastRTPS)
...
def generate_test_description():
    """Generate launch description for rclcpp CPU pub to rclpy CPU sub test."""
    publisher_node = Node(
...
class TestRclcppPubCpuRclpySubCpuFastRTPS(unittest.TestCase):
    """Test case for rclcpp CPU publisher to rclpy CPU subscriber."""
    ...
    def setUp(self):
        self.node = rclpy.create_node('test_rclcpp_pub_cpu_rclpy_sub_cpu_fastrtps')
    ...
    def test_rclcpp_pub_cpu_rclpy_sub_cpu_messages_delivered(self):
        """Test rclcpp CPU publisher to rclpy CPU subscriber."""
...
class TestRclcppPubCpuRclpySubCpuFastRTPSShutdown(unittest.TestCase):
