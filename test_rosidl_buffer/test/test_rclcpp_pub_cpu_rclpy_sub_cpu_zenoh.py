...
class TestRclcppPubCpuRclpySubCpu(unittest.TestCase):
    ...
    def setUp(self):
        self.node = rclpy.create_node('test_rclcpp_pub_cpu_rclpy_sub_cpu')
...
class TestRclcppPubCpuRclpySubCpuShutdown(unittest.TestCase):
