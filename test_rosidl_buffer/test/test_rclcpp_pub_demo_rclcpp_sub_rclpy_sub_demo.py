...
#
# Launch test: 1 rclcpp publisher (demo) to 1 rclcpp subscriber + 1 rclpy subscriber (demo).
...
class TestRclcppPubDemoMixedSub(unittest.TestCase):
    ...
    def setUp(self):
        self.node = rclpy.create_node('test_rclcpp_pub_demo_mixed_sub')
...
class TestRclcppPubDemoMixedSubShutdown(unittest.TestCase):
