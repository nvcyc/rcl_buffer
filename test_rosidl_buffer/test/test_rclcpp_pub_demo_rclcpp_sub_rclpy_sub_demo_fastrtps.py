...
#
# Launch test: 1 rclcpp publisher (demo) to 1 rclcpp subscriber +
# 1 rclpy subscriber (demo). (FastRTPS)
# Validates that a single C++ publisher can deliver demo-backend-backed Buffer data
...
def generate_test_description():
    """Launch rclcpp demo pub with rclcpp + rclpy demo subscribers."""
    publisher_node = Node(
...
class TestRclcppPubDemoMixedSubFastRTPS(unittest.TestCase):
    """Test rclcpp demo pub to rclcpp + rclpy demo subscribers."""
    ...
    def setUp(self):
        self.node = rclpy.create_node('test_rclcpp_pub_demo_mixed_sub_fastrtps')
    ...
    def test_messages_delivered(self):
        """Test rclcpp demo pub delivers to both rclcpp and rclpy subscribers."""
...
class TestRclcppPubDemoMixedSubFastRTPSShutdown(unittest.TestCase):
