...
class TestRclpyCpuToCpuFastRTPS(unittest.TestCase):
    ...
    def setUp(self):
        self.node = rclpy.create_node('test_rclpy_cpu_to_cpu_fastrtps')
...
class TestRclpyCpuToCpuFastRTPSShutdown(unittest.TestCase):
