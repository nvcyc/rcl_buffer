...
#
# Launch test: 1 rclpy publisher (CPU) to 1 rclcpp subscriber (CPU).
...
class TestRclpyPubCpuRclcppSubCpu(unittest.TestCase):
    ...
    def setUp(self):
        self.node = rclpy.create_node('test_rclpy_pub_cpu_rclcpp_sub_cpu')
...
class TestRclpyPubCpuRclcppSubCpuShutdown(unittest.TestCase):
