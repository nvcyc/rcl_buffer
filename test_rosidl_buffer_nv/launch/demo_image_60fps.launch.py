...
def generate_launch_description():
    ...
    publisher = Node(
        ...
        name='demo_image_60fps_publisher',
        output='screen',
        parameters=[{
            'backend_mode': 'demo',
    ...
    subscriber = Node(
        ...
        name='demo_image_60fps_subscriber',
        output='screen',
        parameters=[{
            'topic_name': topic_name,
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument(
            'topic_name',
            default_value='demo_image_60fps',
            description='Image topic used by the demo backend publisher and subscriber.',
        ),
        DeclareLaunchArgument(
            'publish_rate_ms',
            default_value='17',
