...
def generate_test_description():
    """Generate launch description for CPU-to-CPU pub/sub test with explicit cpu option."""
    publisher_node = Node(
...
class TestCpuToCpuExplicit(unittest.TestCase):
    """Test case for CPU-to-CPU image pub/sub with explicit cpu backend option."""
    ...
    def setUp(self):
        self.node = rclpy.create_node('test_cpu_to_cpu_explicit')
    ...
    def test_cpu_to_cpu_explicit_messages_delivered(self):
        """Test CPU pub to CPU sub with explicit acceptable_buffer_backends='cpu'."""
...
class TestCpuToCpuExplicitShutdown(unittest.TestCase):
    """Test shutdown behavior for CPU to CPU with explicit cpu option."""
