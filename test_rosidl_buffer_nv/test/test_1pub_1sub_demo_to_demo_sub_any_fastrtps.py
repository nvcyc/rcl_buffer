...
#
# Launch test: demo pub to demo sub with acceptable_buffer_backends="any" (FastRTPS)
...
class TestDemoDemoSubAnyFastRTPS(unittest.TestCase):
    ...
    def setUp(self):
        self.node = rclpy.create_node('test_demo_demo_sub_any_fastrtps')
