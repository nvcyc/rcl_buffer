...
#
# Launch test: demo pub to demo sub with acceptable_buffer_backends="demo" (FastRTPS)
...
def generate_test_description():
    """Demo pub to sub with acceptable_buffer_backends='demo'."""
    publisher_node = Node(
    ...
    subscriber_node = Node(
        ...
        parameters=[{
            ...
            'acceptable_buffer_backends': 'demo',
            'count_topic_suffix': '',
        }],
    )
...
class TestDemoDemoSubDemoFastRTPS(unittest.TestCase):
    """Demo to demo with acceptable_buffer_backends='demo'."""
    ...
    def setUp(self):
        self.node = rclpy.create_node('test_demo_demo_sub_demo_fastrtps')
    ...
    def test_demo_to_demo_sub_demo(self):
        """Demo pub to sub with 'demo' should receive demo-backend data."""
