...
class TestIntraCpuInterDemoFastRTPS(unittest.TestCase):
    """1 demo pub → 1 cpu-only intra sub + 1 demo-accepting inter sub (mixed, FastRTPS)."""
    ...
    def setUp(self):
        self.node = rclpy.create_node('test_intra_cpu_inter_demo_fastrtps')
        self.intra_count = 0
        self.inter_count = 0
...
class TestIntraCpuInterDemoFastRTPSShutdown(unittest.TestCase):
