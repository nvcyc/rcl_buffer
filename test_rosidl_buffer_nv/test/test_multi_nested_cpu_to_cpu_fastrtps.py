...
# CPU-backend subscriber over rmw_fastrtps_cpp. Baseline case: nested
# uint8_values fields are built via standard CPU path and must arrive as
# CPU-backed Buffers.
...
class TestMultiNestedCpuToCpuFastRTPS(unittest.TestCase):
    ...
    def setUp(self):
        self.node = rclpy.create_node('test_multi_nested_cpu_to_cpu_fastrtps')
...
class TestMultiNestedCpuToCpuFastRTPSShutdown(unittest.TestCase):
