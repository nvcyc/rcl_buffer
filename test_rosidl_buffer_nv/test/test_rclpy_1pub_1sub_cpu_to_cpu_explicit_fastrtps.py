...
#
# Launch test: 1 rclpy publisher to 1 rclpy subscriber, CPU backend to CPU backend. (FastRTPS)
...
class TestRclpyCpuToCpuExplicitFastRTPS(unittest.TestCase):
    ...
    def setUp(self):
        self.node = rclpy.create_node('test_rclpy_cpu_to_cpu_explicit_fastrtps')
...
class TestRclpyCpuToCpuExplicitFastRTPSShutdown(unittest.TestCase):
