...
#
# Launch test: 1 rclpy publisher (CPU) to 1 rclcpp subscriber +
...
class TestRclpyPubCpuMixedSubFastRTPS(unittest.TestCase):
    ...
    def setUp(self):
        self.node = rclpy.create_node('test_rclpy_pub_cpu_mixed_sub_fastrtps')
...
class TestRclpyPubCpuMixedSubFastRTPSShutdown(unittest.TestCase):
