...
#
# Launch test: rclpy same-process pub/sub, CPU backend (Zenoh)
#
...
# session.  Validates that the CPU/array.array path works end-to-end
...
class TestRclpySameProcessCpuToCpuZenoh(unittest.TestCase):
...
class TestRclpySameProcessCpuToCpuZenohShutdown(unittest.TestCase):
