...
class TestRclpyServiceCpuZenoh(unittest.TestCase):
    """Validate rclpy CPU service request/response over Zenoh."""
    ...
    def setUp(self):
        self.node = rclpy.create_node('test_rclpy_service_cpu_zenoh')
...
class TestRclpyServiceCpuZenohShutdown(unittest.TestCase):
