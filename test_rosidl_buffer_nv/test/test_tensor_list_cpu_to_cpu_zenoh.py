...
# CPU-backend subscriber over rmw_zenoh_cpp. Baseline case — every nested
# `tensor.data` field is populated via the standard CPU path
...
class TestTensorListCpuToCpuZenoh(unittest.TestCase):
    ...
    def setUp(self):
        self.node = rclpy.create_node('test_tensor_list_cpu_to_cpu_zenoh')
...
class TestTensorListCpuToCpuZenohShutdown(unittest.TestCase):
