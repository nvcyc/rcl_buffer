...
# `tensor.data` Buffer arrive on the CPU backend with identical content.
...
class TestTensorListDemoToCpuFastRTPS(unittest.TestCase):
    ...
    def setUp(self):
        self.node = rclpy.create_node('test_tensor_list_demo_to_cpu_fastrtps')
...
class TestTensorListDemoToCpuFastRTPSShutdown(unittest.TestCase):
