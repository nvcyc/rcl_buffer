...
#
# Publisher constructs every nested `tensor.data` via DemoBufferImpl; the
...
class TestTensorListDemoToCpuZenoh(unittest.TestCase):
    ...
    def setUp(self):
        self.node = rclpy.create_node('test_tensor_list_demo_to_cpu_zenoh')
...
class TestTensorListDemoToCpuZenohShutdown(unittest.TestCase):
