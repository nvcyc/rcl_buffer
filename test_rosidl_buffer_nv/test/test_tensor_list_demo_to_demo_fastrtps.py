...
# backend is preserved end-to-end through TensorList -> Tensor -> Tensor.data.
...
class TestTensorListDemoToDemoFastRTPS(unittest.TestCase):
    ...
    def setUp(self):
        self.node = rclpy.create_node(
            'test_tensor_list_demo_to_demo_fastrtps')
...
class TestTensorListDemoToDemoFastRTPSShutdown(unittest.TestCase):
